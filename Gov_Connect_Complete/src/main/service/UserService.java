...
public class UserService {
    ...
    public static boolean addUserToDb(String uName, String emailId, String password, String gender, String dob, String address, int pincode, String mobile_no,
            String aadhaar) {
        ...
        if (getOptionalPreparedStatement.isPresent()) {
            try (PreparedStatement preparedStatement = getOptionalPreparedStatement.get()) {
                ...
                preparedStatement.setString(7, aadhaar);
