...
public class UserController {
    ...
    public static boolean addUser(String uName, String emailId, String password,String gender, String dob, String address, int pincode, String mobile_no,String aadhar_No) {
        if (!UserService.checkUserAlreadyInDb(emailId)) {
            System.out.println("ture");
            return UserService.addUserToDb(uName, emailId, password,gender, dob, address,pincode, mobile_no, aadhar_No);
        }
        return false;
    }
